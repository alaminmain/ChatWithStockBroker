...
This project is a real-time Live Stock and Chat application built with ASP.NET Core for the backend and both Angular and React for the frontend, utilizing SignalR for real-time communication.
...
- .NET SDK 9.0 or later
- Node.js and npm (or Yarn)
- Angular CLI (for Angular client): `npm install -g @angular/cli`
- SQL Server Express (or any compatible SQL Server instance)
...
3.  **Run the Frontend Application:**
    ...
    npm start
    ```
    The React application will typically run on `http://localhost:3000`. Open your browser to this URL.
