...
namespace StockMarket.Api.Migrations
{
    ...
    [Migration("20251006115016_AddFinancialReports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockMarket.Api.Models.Comp", b =>
                {
                    ...
                    b.Property<DateTime?>("LastAgmHeld")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal?>("NetAssetValPerShare")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("NocfPerShare")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("SharePercentageDirector")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("SharePercentageForeign")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("SharePercentageGovt")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("SharePercentageInstitute")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("SharePercentagePublic")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("StockMarket.Api.Models.FinancialReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StockMarket.Api.Models.FinancialReportEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OriginalAccountName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StandardAccountName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("FinancialReportEntries");
                });
            ...
            modelBuilder.Entity("StockMarket.Api.Models.FinancialReportEntry", b =>
                {
                    b.HasOne("StockMarket.Api.Models.FinancialReport", "FinancialReport")
                        .WithMany("Entries")
